...
import {CustomersIcon} from '../common/MenuIcons'
...
export default class CustomerAdminMain extends React.Component {
  constructor(props) {
    ...
    this.state = {
      activeTab:'/app/sysadmin/customers'
    };
  ...
  render() {
    let tabs = [
      {linkName:'/app/sysadmin/customers', displayName:'Customers',icon:<CustomersIcon />},
      // {linkName:'/app/sysadmin/partners', displayName:'Partners'},
    ]
        ...
        <table width='100%' >
          ...
          <tr>
            ...
            <td style={{width:'99%',verticalAlign:'top'}}>
              <Header header="Cavirin Admin Portal"/>
              <span>
                {this.props.children}
              </span>
            </td>
